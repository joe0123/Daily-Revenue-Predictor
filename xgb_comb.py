...
MODEL_ADR = XGBRegressor(tree_method="gpu_hist", predictor="gpu_predictor", random_state=0, \
                        n_estimators=100, learning_rate=0.1, min_child_weight=12, max_depth=7, gamma=0, \
                        subsample=0.9, colsample_bytree=0.6, reg_lambda=1, reg_alpha=0)
...
MODEL_CANCEL = XGBClassifier(objective="binary:logistic", eval_metric="error", \
                            ...
                            subsample=0.6, colsample_bytree=0.9, reg_lambda=1, reg_alpha=1e-1)
