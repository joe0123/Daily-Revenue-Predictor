...
MODEL_ADR = RandomForestRegressor(n_estimators=800, min_samples_split=10, min_samples_leaf=1, max_features="auto", max_depth=40, criterion='mse', random_state=0, n_jobs=-1)
MODEL_CANCEL = LogisticRegression(max_iter=1e+8)
